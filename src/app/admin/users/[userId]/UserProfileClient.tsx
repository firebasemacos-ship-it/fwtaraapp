...
const statusConfig: { [key in OrderStatus]: { text: string; className: string } } = {
    ...
    office_pickup: { text: 'استلام فالمكتب', className: 'bg-amber-500/10 text-amber-500 border-amber-500/20' },
    transferred_to_rep: { text: 'تحويل للمندوب', className: 'bg-sky-500/10 text-sky-500 border-sky-500/20' },
